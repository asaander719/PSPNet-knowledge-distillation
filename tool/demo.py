...
def get_parser():
    ...
    parser.add_argument('--image', type=str, default='figure/demo/test_real_1.jpg', help='input image')
    parser.add_argument('--image', type=str, default='figure/demo/test_real_2.jpg', help='input image')
    parser.add_argument('--image', type=str, default='figure/demo/test_real_3.jpg', help='input image')
    parser.add_argument('--image', type=str, default='figure/demo/test_real_4.jpg', help='input image')
